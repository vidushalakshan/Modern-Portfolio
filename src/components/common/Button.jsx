...
export const Button = ({
  ...
  const variantStyles = {
    ...
    bgwhite: "bg-[#F1F1F1] text-black hover:text-white",
  };
  ...
  const hoverBgAnimation =
    variant === "primary"
      ...
      : variant === "bgwhite"
      ? "before:absolute before:top-0 before:left-0 before:h-full before:w-0 hover:before:w-full before:rounded-full before:bg-[#2189ff] before:z-0 before:transition-all before:duration-500 before:ease-in-out before:shadow-[0_4px_12px_rgba(33,137,255,0.4)]"
      : "";
